        ...
        <div class="row">
          ...
          <div class="col-md-6" style="position:relative; margin:0 auto;">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{url('admin/article/'.$field->art_id)}}" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label style="line-height:38px;">分類</label>
                        <select class="form-control select2 select2-hidden-accessible" name="cate_id" style="width: 80%; float:right;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                          @foreach($data as $d)
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="width: 80%; float:right;" name="art_thumb" value="{{$field->art_thumb}}">
                  ...
                  <div class="form-group">
                    <img src="http://127.0.0.1/order/{{$field->art_thumb}}" alt="" id="art_thumb_img" style="max-width: 350px;max-height: 100px">                    
                  </div>
                  <div class="form-group">
                    <label style="line-height:38px;">關鍵字</label>
                    <input type="text" class="form-control" name="art_tag" style="width: 80%; float:right;" value="{{$field->art_tag}}">                    
                  </div>
                  <div class="form-group">
                    <label style="line-height:38px;">描述</label>
                    <textarea class="form-control" name="art_description" rows="2" style="width: 80%; float:right;">{{$field->art_description}}</textarea>
                  </div>
                  <div class="form-group">
                    ...
                    <script id="editor" name="art_content" type="text/plain" style="width:620px;height:500px;">{!! $field->art_content !!}</script>
                    <script type="text/javascript">
